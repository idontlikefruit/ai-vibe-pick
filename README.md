...
![Data](https://img.shields.io/badge/data%20as%20of-2026--08--31-brightgreen)
...
> 告诉我你要做什么项目，我基于本仓库 **143 个真实 GitHub 项目（其中 AI 相关 71 个）** 的技术栈数据，给你一套有据可依的选型推荐（不凭空编造，每个推荐都引用真实项目）。
...
| :---: | :--- | ---: | :--- | :---: | :--- | :--- |
| 1 | [codecrafters-io/build-your-own-x](https://github.com/codecrafters-io/build-your-own-x) | 543,930 | Markdown | 否 | 教程 | Master programming by recreating your fav… |
| 2 | [sindresorhus/awesome](https://github.com/sindresorhus/awesome) | 501,197 | 未标注 | 否 | Awesome 清单 | 😎 Awesome lists about all kinds of intere… |
| 3 | [public-apis/public-apis](https://github.com/public-apis/public-apis) | 472,863 | Python | 否 | API 清单 | A collective list of free APIs |
| 4 | [freeCodeCamp/freeCodeCamp](https://github.com/freeCodeCamp/freeCodeCamp) | 454,714 | TypeScript | 否 | React, Node.js | freeCodeCamp.org's open-source codebase a… |
| 5 | [EbookFoundation/free-programming-books](https://github.com/EbookFoundation/free-programming-books) | 395,547 | Python | 否 | 书籍 | :books: Freely available programming books |
| 6 | [openclaw/openclaw](https://github.com/openclaw/openclaw) | 388,026 | TypeScript | 是 | TypeScript | Your own personal AI assistant. Any OS. A… |
| 7 | [donnemartin/system-design-primer](https://github.com/donnemartin/system-design-primer) | 366,759 | Python | 否 | 教程 | Learn how to design large-scale systems. … |
| 8 | [nilbuild/developer-roadmap](https://github.com/nilbuild/developer-roadmap) | 365,858 | TypeScript | 否 | Next.js, React | Interactive roadmaps, guides and other ed… |
| 9 | [jwasham/coding-interview-university](https://github.com/jwasham/coding-interview-university) | 359,974 | 未标注 | 否 | 教程 | A complete computer science study plan to… |
| 10 | [vinta/awesome-python](https://github.com/vinta/awesome-python) | 317,044 | Python | 否 | Awesome 清单 | The definitive list that answers "I want … |
| 11 | [awesome-selfhosted/awesome-selfhosted](https://github.com/awesome-selfhosted/awesome-selfhosted) | 316,029 | 未标注 | 否 | Awesome 清单 | A list of Free Software network services … |
| 12 | [practical-tutorials/project-based-learning](https://github.com/practical-tutorials/project-based-learning) | 281,276 | Python | 否 | 教程 | Curated list of project-based tutorials |
| 13 | [obra/superpowers](https://github.com/obra/superpowers) | 279,414 | Shell | 是 | Shell, Claude Code | An agentic skills framework & software de… |
| 14 | [996icu/996.ICU](https://github.com/996icu/996.ICU) | 276,802 | 未标注 | 否 | 社会议题 | Repo for counting stars and contributing.… |
| 15 | [react/react](https://github.com/react/react) | 248,321 | JavaScript | 否 | React | The library for web and native user inter… |
| 16 | [torvalds/linux](https://github.com/torvalds/linux) | 245,220 | C | 否 | C, Linux 内核 | Linux kernel source tree |
| 17 | [affaan-m/ECC](https://github.com/affaan-m/ECC) | 244,314 | JavaScript | 是 | JavaScript, Claude Code, Codex | The agent harness performance optimizatio… |
| 18 | [mattpocock/skills](https://github.com/mattpocock/skills) | 241,128 | Shell | 是 | Shell, Claude Code | Skills for Real Engineers. Straight from … |
| 19 | [trimstray/the-book-of-secret-knowledge](https://github.com/trimstray/the-book-of-secret-knowledge) | 241,111 | 未标注 | 否 | 清单 | A collection of inspiring lists, manuals,… |
| 20 | [NousResearch/hermes-agent](https://github.com/NousResearch/hermes-agent) | 238,187 | Python | 是 | Python | The agent that grows with you |
| 21 | [TheAlgorithms/Python](https://github.com/TheAlgorithms/Python) | 224,116 | Python | 否 | Python, 算法 | All Algorithms implemented in Python |
| 22 | [vuejs/vue](https://github.com/vuejs/vue) | 211,004 | TypeScript | 否 | Vue 2 | This is the repo for Vue 2. For Vue 3, go… |
| 23 | [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) | 208,694 | 未标注 | 是 | 未标注, Claude Code | A single CLAUDE.md file to improve Claude… |
| 24 | [ossu/computer-science](https://github.com/ossu/computer-science) | 208,541 | HTML | 否 | 教程 | 🎓 Path to a free self-taught education in… |
| 25 | [deepseek-ai/deepseek-harness](https://github.com/deepseek-ai/deepseek-harness) | 203,607 | TypeScript | 否 | TypeScript | DeepSeek Harness: Everything is a Plugin. |
| 26 | [n8n-io/n8n](https://github.com/n8n-io/n8n) | 202,822 | TypeScript | 是 | TypeScript, Vue 3, Vue Flow, Pr… | Fair-code workflow automation platform wi… |
| 27 | [anomalyco/opencode](https://github.com/anomalyco/opencode) | 202,414 | TypeScript | 是 | TypeScript, Node.js | The open source coding agent. |
| 28 | [tensorflow/tensorflow](https://github.com/tensorflow/tensorflow) | 198,020 | C++ | 是 | C, Python | An Open Source Machine Learning Framework… |
| 29 | [trekhleb/javascript-algorithms](https://github.com/trekhleb/javascript-algorithms) | 196,580 | JavaScript | 否 | JavaScript, 算法 | 📝 Algorithms and data structures implemen… |
| 30 | [DigitalPlatDev/FreeDomain](https://github.com/DigitalPlatDev/FreeDomain) | 196,440 | Markdown | 否 | HTML | Free domain registration and practical DN… |
| 31 | [ultraworkers/claw-code](https://github.com/ultraworkers/claw-code) | 195,148 | Rust | 是 | Rust | An agent-managed museum exhibit, built in… |
| 32 | [microsoft/vscode](https://github.com/microsoft/vscode) | 190,042 | TypeScript | 否 | TypeScript, Electron | Visual Studio Code |
| 33 | [ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh) | 189,446 | Shell | 否 | Shell, Zsh | 🙃   A delightful community-driven (with 2… |
| 34 | [massgravel/Microsoft-Activation-Scripts](https://github.com/massgravel/Microsoft-Activation-Scripts) | 188,702 | Batchfile | 否 | Batchfile | Open-source Windows and Office activator … |
| 35 | [yt-dlp/yt-dlp](https://github.com/yt-dlp/yt-dlp) | 187,778 | Python | 否 | Python | A feature-rich command-line audio/video d… |
| 36 | [Significant-Gravitas/AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) | 186,993 | Python | 是 | Python, Next.js, React, FastAPI… | AutoGPT is the vision of accessible AI fo… |
| 37 | [jackfrued/Python-100-Days](https://github.com/jackfrued/Python-100-Days) | 185,730 | Jupyter Notebook | 否 | Jupyter, Python | Python - 100天从新手到大师 |
| 38 | [CyC2018/CS-Notes](https://github.com/CyC2018/CS-Notes) | 185,704 | 未标注 | 否 | 面试 | :books: 技术面试必备基础知识、Leetcode、计算机操作系统、计算机网络… |
| 39 | [getify/You-Dont-Know-JS](https://github.com/getify/You-Dont-Know-JS) | 184,761 | 未标注 | 否 | 书籍 | A book series (2 published editions) on t… |
| 40 | [avelino/awesome-go](https://github.com/avelino/awesome-go) | 182,651 | Go | 否 | Awesome 清单 | A curated list of awesome Go frameworks, … |
| 41 | [ollama/ollama](https://github.com/ollama/ollama) | 179,750 | Go | 是 | Go, CLI, llama.cpp | Get up and running with Kimi-K2.6, GLM-5.… |
| 42 | [flutter/flutter](https://github.com/flutter/flutter) | 178,712 | Dart | 否 | Dart, Flutter | Flutter makes it easy and fast to build b… |
| 43 | [microsoft/markitdown](https://github.com/microsoft/markitdown) | 177,050 | Python | 是 | Python | Python tool for converting files and offi… |
| 44 | [github/gitignore](https://github.com/github/gitignore) | 175,504 | 未标注 | 否 | 模板 | A collection of useful .gitignore templat… |
...
| 46 | [firecrawl/firecrawl](https://github.com/firecrawl/firecrawl) | 174,126 | TypeScript | 是 | TypeScript, Next.js, Node.js | The context API to search, scrape, and in… |
| 47 | [521xueweihan/HelloGitHub](https://github.com/521xueweihan/HelloGitHub) | 173,643 | Python | 否 | Python | :octocat: 分享 GitHub 上有趣、入门级的开源项目。Share in… |
| 48 | [anthropics/skills](https://github.com/anthropics/skills) | 172,493 | Python | 是 | Python, Claude | Public repository for Agent Skills |
| 49 | [f/prompts.chat](https://github.com/f/prompts.chat) | 168,182 | HTML | 是 | HTML, ChatGPT | f.k.a. Awesome ChatGPT Prompts. Share, di… |
| 50 | [AUTOMATIC1111/stable-diffusion-webui](https://github.com/AUTOMATIC1111/stable-diffusion-webui) | 164,724 | Python | 是 | Python, Gradio, FastAPI, 本地文件, … | Stable Diffusion web UI |
| 51 | [huggingface/transformers](https://github.com/huggingface/transformers) | 164,618 | Python | 是 | Python | 🤗 Transformers: the model-definition fram… |
| 52 | [jlevy/the-art-of-command-line](https://github.com/jlevy/the-art-of-command-line) | 162,188 | 未标注 | 否 | 清单 | Master the command line, in one page |
| 53 | [Snailclimb/JavaGuide](https://github.com/Snailclimb/JavaGuide) | 158,122 | JavaScript | 否 | Java, 面试 | Java 面试 & 后端通用面试指南，覆盖计算机基础、数据库、分布式、高并发、系统… |
| 54 | [langflow-ai/langflow](https://github.com/langflow-ai/langflow) | 153,871 | Python | 是 | Python, React, FastAPI, SQLite,… | Langflow is a powerful tool for building … |
| 55 | [langgenius/dify](https://github.com/langgenius/dify) | 153,852 | TypeScript | 是 | TypeScript, Next.js, React, Tai… | Build Agentic workflows, RAG pipelines, w… |
| 56 | [open-webui/open-webui](https://github.com/open-webui/open-webui) | 150,363 | Python | 是 | Python, SvelteKit, FastAPI, SQL… | User-friendly AI Interface (Supports Olla… |
| 57 | [msitarzewski/agency-agents](https://github.com/msitarzewski/agency-agents) | 148,869 | Shell | 是 | Shell | A complete AI agency at your fingertips -… |
| 58 | [Genymobile/scrcpy](https://github.com/Genymobile/scrcpy) | 148,527 | C | 否 | C, Android | Display and control your Android device |
| 59 | [airbnb/javascript](https://github.com/airbnb/javascript) | 148,144 | JavaScript | 否 | JavaScript, 风格指南 | JavaScript Style Guide |
| 60 | [langchain-ai/langchain](https://github.com/langchain-ai/langchain) | 145,256 | Python | 是 | Python | The agent engineering platform. |
| 61 | [anthropics/claude-code](https://github.com/anthropics/claude-code) | 143,414 | Python | 是 | Python, Claude | Claude Code is an agentic coding tool tha… |
| 62 | [x1xhlol/system-prompts-and-models-of-ai-tools](https://github.com/x1xhlol/system-prompts-and-models-of-ai-tools) | 143,225 | 未标注 | 是 | 未标注 | FULL Augment Code, Claude Code, Cluely, C… |
| 63 | [yangshun/tech-interview-handbook](https://github.com/yangshun/tech-interview-handbook) | 142,295 | TypeScript | 否 | React, TypeScript | Curated coding interview preparation mate… |
| 64 | [vercel/next.js](https://github.com/vercel/next.js) | 142,014 | JavaScript | 否 | Next.js, React, JavaScript | The React Framework |
| 65 | [ytdl-org/youtube-dl](https://github.com/ytdl-org/youtube-dl) | 141,056 | Python | 否 | Python | Command-line program to download videos f… |
| 66 | [clash-verge-rev/clash-verge-rev](https://github.com/clash-verge-rev/clash-verge-rev) | 140,996 | TypeScript | 否 | Tauri, TypeScript | A modern GUI client based on Tauri, desig… |
| 67 | [microsoft/PowerToys](https://github.com/microsoft/PowerToys) | 138,210 | C | 否 | C++, C# | Microsoft PowerToys is a collection of ut… |
| 68 | [iptv-org/iptv](https://github.com/iptv-org/iptv) | 137,041 | TypeScript | 否 | TypeScript | Collection of publicly available IPTV cha… |
| 69 | [golang/go](https://github.com/golang/go) | 136,822 | Go | 否 | Go | The Go programming language |
| 70 | [ripienaar/free-for-dev](https://github.com/ripienaar/free-for-dev) | 135,897 | HTML | 否 | 清单 | A list of SaaS, PaaS and IaaS offerings t… |
| 71 | [labuladong/fucking-algorithm](https://github.com/labuladong/fucking-algorithm) | 135,500 | Markdown | 否 | 算法 | Crack LeetCode, not only how, but also wh… |
| 72 | [Shubhamsaboo/awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) | 135,173 | Python | 是 | Python | 100+ AI Agents, Agent Skills and RAG Apps… |
| 73 | [github/spec-kit](https://github.com/github/spec-kit) | 132,203 | Python | 是 | Python | 💫 Toolkit to help you get started with Sp… |
| 74 | [excalidraw/excalidraw](https://github.com/excalidraw/excalidraw) | 130,777 | TypeScript | 否 | React, TypeScript, Canvas | Virtual whiteboard for sketching hand-dra… |
| 75 | [Comfy-Org/ComfyUI](https://github.com/Comfy-Org/ComfyUI) | 130,650 | Python | 是 | Python, TypeScript, 自定义节点编辑器, a… | The most powerful and modular diffusion m… |
| 76 | [garrytan/gstack](https://github.com/garrytan/gstack) | 130,359 | TypeScript | 是 | TypeScript, Claude Code | Use Garry Tan's exact Claude Code setup: … |
| 77 | [farion1231/cc-switch](https://github.com/farion1231/cc-switch) | 130,104 | Rust | 是 | Rust, Web, Tauri, Claude, Codex… | A cross-platform desktop All-in-One assis… |
| 78 | [krahets/hello-algo](https://github.com/krahets/hello-algo) | 129,672 | Java | 否 | Java, 算法 | 《Hello 算法》：动画图解、一键运行的数据结构与算法教程。支持简中、繁中、En… |
| 79 | [Chalarangelo/30-seconds-of-code](https://github.com/Chalarangelo/30-seconds-of-code) | 128,854 | JavaScript | 否 | JavaScript | Coding articles to level up your developm… |
...
| 81 | [ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp) | 126,276 | C++ | 是 | C, C++, ggml | LLM inference in C/C++ |
| 82 | [kubernetes/kubernetes](https://github.com/kubernetes/kubernetes) | 125,571 | Go | 否 | Go | Production-Grade Container Scheduling and… |
| 83 | [nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill) | 122,987 | Python | 是 | Claude Code, UI/UX, 设计技能 | An AI skill that provides design intellig… |
| 84 | [electron/electron](https://github.com/electron/electron) | 122,793 | C++ | 否 | C++, JavaScript, Electron | :electron: Build cross-platform desktop a… |
| 85 | [shadcn-ui/ui](https://github.com/shadcn-ui/ui) | 122,526 | TypeScript | 否 | React, Radix UI, Tailwind | A set of beautifully-designed, accessible… |
| 86 | [rustdesk/rustdesk](https://github.com/rustdesk/rustdesk) | 122,120 | Rust | 否 | Rust, Flutter | An open-source remote desktop application… |
| 87 | [nodejs/node](https://github.com/nodejs/node) | 119,951 | JavaScript | 否 | JavaScript, C++, V8 | Node.js JavaScript runtime ✨🐢🚀✨ |
| 88 | [openai/codex](https://github.com/openai/codex) | 119,868 | Rust | 否 | Rust | Lightweight coding agent that runs in you… |
| 89 | [Hack-with-Github/Awesome-Hacking](https://github.com/Hack-with-Github/Awesome-Hacking) | 119,328 | 未标注 | 否 | Awesome 清单 | A collection of various awesome lists for… |
| 90 | [microsoft/generative-ai-for-beginners](https://github.com/microsoft/generative-ai-for-beginners) | 118,763 | Jupyter Notebook | 是 | Jupyter Notebook, Jupyter, Azur… | 21 Lessons, Get Started Building with Gen… |
| 91 | [justjavac/free-programming-books-zh_CN](https://github.com/justjavac/free-programming-books-zh_CN) | 118,556 | 未标注 | 否 | 书籍 | :books: 免费的计算机编程类中文书籍，欢迎投稿 |
| 92 | [harry0703/MoneyPrinterTurbo](https://github.com/harry0703/MoneyPrinterTurbo) | 118,547 | Python | 否 | Python | 利用 AI 大模型和自动化工作流，根据主题或关键词一键生成高清短视频。Genera… |
| 93 | [rust-lang/rust](https://github.com/rust-lang/rust) | 116,634 | Rust | 否 | Rust | Empowering everyone to build reliable and… |
| 94 | [DietrichGebert/ponytail](https://github.com/DietrichGebert/ponytail) | 116,474 | JavaScript | 否 | JavaScript | Makes your AI agent think like the lazies… |
| 95 | [godotengine/godot](https://github.com/godotengine/godot) | 116,367 | C++ | 否 | C++, Godot | Godot Engine – Multi-platform 2D and 3D g… |
| 96 | [2dust/v2rayN](https://github.com/2dust/v2rayN) | 114,946 | C# | 否 | C# | A GUI client for Windows, Linux and macOS… |
| 97 | [mrdoob/three.js](https://github.com/mrdoob/three.js) | 114,928 | JavaScript | 否 | WebGL, JavaScript | JavaScript 3D Library. |
| 98 | [d3/d3](https://github.com/d3/d3) | 113,574 | Shell | 否 | JavaScript, D3 | Bring data to life with SVG, Canvas and H… |
| 99 | [immich-app/immich](https://github.com/immich-app/immich) | 112,943 | TypeScript | 否 | TypeScript, Svelte, PostgreSQL,… | High performance self-hosted photo and vi… |
| 100 | [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | 112,343 | Python | 否 | Python | Turn any codebase, with its docs, SQL sch… |
...
> 来源：https://github.com/trending （全语言 daily）｜采集：2026-08-31 ｜ 数据：[`data/trending-daily.csv`](data/trending-daily.csv) · 完整分析：[`reports/trending-analysis.md`](reports/trending-analysis.md)
...
> 以 `full_name` 为主键 **upsert（更新或插入）** 合并三个来源：`projects.csv`(curated) + `top-100-stars.csv` + `trending-daily.csv` → 共 **143 个**，其中 AI 相关 71 个、Top-100 项目 100 个、今日 Trending 项目 19 个。
