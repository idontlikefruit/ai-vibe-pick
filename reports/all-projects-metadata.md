...
> upsert 规范化存储 ｜ 采集：2026-09-09 ｜ 数据：[`data/projects-metadata.csv`](../data/projects-metadata.csv)
...
| 字段 | 值 |
| :--- | :--- |
| 仓库 | [viarotel-org/escrcpy]() |
| Stars | 11,365 |
| Top-100 / Trending | — / 是 |
| 类别 / AI | — / 否 |
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | JavaScript, android, genymobile, gnirehtet, gui |
| 来源 | trending |
