...
> upsert 规范化存储 ｜ 采集：2026-09-02 ｜ 数据：[`data/projects-metadata.csv`](../data/projects-metadata.csv)
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, academic-pipeline, academic-writing, ai-research, claude |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | TypeScript, ai, ai-agent, ai-tools, cli |
| 来源 | trending |
