...
> upsert 规范化存储 ｜ 采集：2026-08-21 ｜ 数据：[`data/projects-metadata.csv`](../data/projects-metadata.csv)
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Go, ai, anthropic, caveman, claude |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Rust, ann, avx512, embedding, embeddings |
| 来源 | trending |
...
## 137. google-timeline-visualizer
