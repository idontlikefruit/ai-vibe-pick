...
> upsert 规范化存储 ｜ 采集：2026-08-02 ｜ 数据：[`data/projects-metadata.csv`](../data/projects-metadata.csv)
...
| Stars | 113,854 |
| Top-100 / Trending | 91 / 是 |
| 类别 / AI | A-AI/Agent生态 / 是 |
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Jupyter Notebook, ai, azure, chatgpt, dall-e |
| 来源 | top100,trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, agent, agentic, agentic-framework, agentic-workflow |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Crystal, agplv3, hacktoberfest, invidious, libre |
| 来源 | trending |

---

## 129. awesome-systematic-trading
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, audiobook, faster-whisper, gradio, karaoke |
| 来源 | trending |

---

## 132. TencentDB-Agent-Memory
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | TypeScript, hacktoberfest, hono, issue-management, issue-tracker |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Go, cli, gh-extension, github, stacked-prs |
| 来源 | trending |
