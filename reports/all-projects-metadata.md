...
> upsert 规范化存储 ｜ 采集：2026-08-28 ｜ 数据：[`data/projects-metadata.csv`](../data/projects-metadata.csv)
...
| 数据库 / LLM | SQLite/PostgreSQL/MySQL / OpenAI/Anthropic/LangChain 节点 |
...
## 91. free-programming-books-zh_CN
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, agent, finance, llm, multiagent |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | JavaScript, ai, ai-agents, ai-memory, anthropic |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | TypeScript, editor, oss, videoeditor |
| 来源 | trending |
...
| 数据库 / LLM | SQLite/Postgres/MySQL / LangChain/多模型 |
| tags | — |
| 来源 | curated |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, agent, agentic-ai, ai, claude |
| 来源 | trending |
...
## 118. ai-engineering-from-scratch
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, agent-skills, ai-scientist, bioinformatics, chemoinformatics |
| 来源 | trending |

---

## 127. claude-plugins-official
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, claude-code, mcp, skills |
| 来源 | trending |
...
| 数据库 / LLM | MongoDB + PostgreSQL / 多模型 |
| tags | — |
| 来源 | curated |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | JavaScript, agent-skills, architecture-as-code, architecture-diagram, claude-skill |
| 来源 | trending |

---

## 135. awesome-gpt-image-2
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | JavaScript, agents, ai-image-generation, chatgpt, dsh-plugin |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, agent-skills, ai-note-taking, ai-second-brain, claude-code |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Nim, privacy, self-hosted, twitter, x |
| 来源 | trending |
...
| 字段 | 值 |
| :--- | :--- |
| 仓库 | [ConardLi/garden-skills]() |
| Stars | 11,310 |
| Top-100 / Trending | — / 是 |
| 类别 / AI | — / 是 |
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | CSS, agent, claude, gpt-image-2, rag |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | JavaScript, 3d-globe, cesium, flight-tracking, geospatial |
| 来源 | trending |
...
## 142. go-modern-guidelines

> Help AI coding agents write modern Go

| 字段 | 值 |
| :--- | :--- |
| 仓库 | [JetBrains/go-modern-guidelines]() |
| Stars | 2,058 |
| Top-100 / Trending | — / 是 |
| 类别 / AI | — / 是 |
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Go, ai-agents, coding-agent, developer-tools, golang |
| 来源 | trending |
