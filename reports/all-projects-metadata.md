...
> upsert 规范化存储 ｜ 采集：2026-09-18 ｜ 数据：[`data/projects-metadata.csv`](../data/projects-metadata.csv)
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Go, bpf, cncf, cni, containers |
| 来源 | trending |

---

## 134. knowledge-work-plugins
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Go, agents, dev-tools, development-environment, golang |
| 来源 | trending |

---

## 136. security-audit-skill
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | TypeScript, agent, browser-use, dsh-plugin |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, agent, agentic-ai, ai, ai-agent |
| 来源 | trending |
