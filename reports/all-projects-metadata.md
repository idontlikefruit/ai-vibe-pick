...
> upsert 规范化存储 ｜ 采集：2026-08-04 ｜ 数据：[`data/projects-metadata.csv`](../data/projects-metadata.csv)
...
| Stars | 360,175 |
| Top-100 / Trending | 8 / 是 |
| 类别 / AI | B-学习资源/Awesome / 否 |
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, design, design-patterns, design-system, development |
| 来源 | top100,trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, agent-infrastructure, ai-agent, ai-search, automation |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | TypeScript, ai, cuda, mlx, qwen3-tts |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Python, Foundation Model, 金融, 时间序列 |
| 来源 | trending |
...
| 前端 / 后端 | — / — |
| 数据库 / LLM | — / — |
| tags | Jupyter Notebook, chinese-llm, chinese-nlp, finetune, generative-ai |
| 来源 | trending |
